...
def context_target_split(x, y, pi, num_context, num_extra_target, include_zero=False):
    ...
    pi : torch.Tensor
        Shape (batch_size, num_points, pi_dim)
    ...
    if include_zero == True:
        # to include boundary condition at start of time series
        locations[0] = 0
